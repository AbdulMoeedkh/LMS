...
const s3Config = {
    ...
    accessKeyId: "AKIAUZPNLSRRCQCWT6NR",  // Store in .env file
    secretAccessKey: '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',  // Store in .env file
};
...
const StudentListingTable = () => {
    ...
    const uploadFileToFirebase = async (file) => {
        try {
            ...
            const fileUrl = `https://${uploadParams.Bucket}.s3.${s3Client.config.region}.amazonaws.com/${fileName}`;
